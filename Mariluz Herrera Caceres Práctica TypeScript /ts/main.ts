...
persona1.setMail(new Mail("personal", "ricky72@gmail.com"));
persona1.setDireccion(
  new Direccion("Falua", "123", "3º", "C", "35124", "San Bartolomé de Tirajana", "Las Palmas")
);
persona1.setTelefono(new Telefono("Casa", "928321123"));
...
persona2.setMail(new Mail("personal", "isabelita@gmail.com"));
persona2.setDireccion(
  new Direccion("Doctor Alemán", "12", "2º", "B", "35110", "Vecindario", "Las Palmas")
);
persona2.setTelefono(new Telefono("Casa", "928349823"));
...
persona3.setMail(new Mail("ejemplo", "patricio@gmail.com"));
persona3.setDireccion(
  new Direccion("Las Bajas", "12", "2º", "B", "35200", "Arnao", "Las Palmas")
);
persona3.setTelefono(new Telefono("Casa", "928092389"));
...
const actualizarPersona = (buscarDni: string) => {
  ...
  //// Nueva información ////
  mipersona.setMail(new Mail("trabajo", "fue_modificado@gmail.com"));
  mipersona.setDireccion(
    new Direccion("probando", "11", "1º", "A", "35000", "Las Pruebas", "Las Palmas")
  );
  mipersona.setTelefono(new Telefono("Movil", "6161616161"));
